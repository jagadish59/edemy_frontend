...
const CourceCreateform=({handleSubmit, handlechange,handleImage,values,setValues,preview,uploadButtenTxt,handleImageRemove})=>{
...
export default CourceCreateform;